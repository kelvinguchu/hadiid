...
import { truckProcess } from "./data";

export function TruckProcessSection() {
  return (
      ...
      <div className='container mx-auto'>
        <AnimatedSection className='text-center mb-6 md:mb-10'>
          ...
          <p className='text-muted-foreground max-w-2xl mx-auto'>
            A systematic approach ensures quality and timely delivery on every
            project.
          </p>
        </AnimatedSection>

        <div className='grid md:grid-cols-2 lg:grid-cols-3 gap-6'>
          {truckProcess.map((item) => (
